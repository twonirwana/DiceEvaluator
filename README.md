...
| Appending                 | `<left> + <right>`                 | `2d6 + 2`                    | Combines the rolls of both sides to a single list                                                                                                                                                            | 1         | left                                | one or more value       | one or more value                  |
| Negative Appending        | `<left> - <right>`                 | `2 - 1` or `-d6`             | Combines the rolls of both sides to a single list. The right side is multiplied by -1.                                                                                                                       | 2         | left for binary and right for unary | one or more value       | one or more numbers                |

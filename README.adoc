...
|List Repeat |`<number>xl<expression>` |`3xl(2d6=)` |Repeats the expression a number of times given in <number> and combines the results in one list. |1 |left |a single number between 1-10 | a expression
